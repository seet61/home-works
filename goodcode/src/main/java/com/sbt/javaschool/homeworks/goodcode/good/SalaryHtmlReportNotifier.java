package com.sbt.javaschool.homeworks.goodcode.good;
...
public class SalaryHtmlReportNotifier {
    ...
    public void generateAndSendHtmlSalaryReport(String departmentId, LocalDate dateFrom, LocalDate dateTo, String recipients) {
        try {
            /*
            * Отдельный приватный метод получения информации
            */
            ...
            /*
            * Применение шаблрнизатора поможет уйти от харкодинга тела письма, и динамическому его заполнению.
            */
            ...
            /*
            * Отельный приватный метод отправки сообщения.
            */
